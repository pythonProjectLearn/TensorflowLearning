...
batch_size = 128
data_dir = '/home/zt/Documents/Data'
output_every = 50
generations = 20000
eval_every = 500
image_height = 32
...
def input_pipeline(batch_size, train_logical=True):
    if train_logical:
        files = [os.path.join(data_dir, 'cifar-10-batches-bin', 'data_batch_{}.bin'.format(i)) for i in range(1,6)]
    else:
        files = [os.path.join(data_dir, 'cifar-10-batches-bin', 'test_batch.bin')]
